...
const setImage = () =>{
    ...
    bgImage.style.backgroundImage = "url('../assets/images/Rectangle 13.svg')";
...
const setSecond = () =>{
    ...
    bgImage.style.backgroundImage = "url('../assets/images/Rectangle\ 28\(1\).svg')";
...
const setimage2 = ()=>{
    ...
    bgImage2.style.backgroundImage = "url('../assets/images/Rectangle 15.svg')";
...
const setImage21=()=>{
    ...
    bgImage2.style.backgroundImage = "url('../assets/images/Vector.svg')";
}
